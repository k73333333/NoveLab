...
void main() async {
  ...
  final hiveDir = path.join(Directory.current.path, 'data');
  final hiveDirectory = await Directory(hiveDir).create(recursive: true);
...
class _MyAppState extends State<MyApp> {
  ...
  final SyncService _syncService = DummySyncService();
